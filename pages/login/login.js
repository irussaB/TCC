    ...
    // Usuários de teste: diego / francesco
    const usuarios = [
      { email: 'diego@escolinha.com',     senha: '12345678', nome: 'Diego' },
      { email: 'francesco@escolinha.com', senha: '12345678', nome: 'Francesco' },
    ];
    ...
    function fazerLogin(e) {
      ...
      if (usuario) {
        // Login OK — salva o professor logado e vai para o painel
        localStorage.setItem('professor-logado', JSON.stringify(usuario));
